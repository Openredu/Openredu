@i9na
    ...
    Scenario: Questão com mesmo enunciado
        ...
        Given que eu estou na tela de criação de provas
        And eu escrever o enunciado de uma questão para prova de "Anatomia" igual a outra da mesma prova
        When eu clico em "Salvar"
        Then o sistema emite uma mensagem de erro "existe uma questão igual a outra em sua prova"
	
    Scenario: Upload de imagem de baixa qualidade                         
       
        Given que eu estou na página de criação de provas
        And eu fizer o upload de uma foto para uma questão da prova "Biologia Parte I"
        When o tamanho da foto for menor que o tamanho "5"
        And eu clico em "Salvar"
        Then o sistema mostra uma mensagem de erro "o tamanho mínimo de um arquivo de foto é 5 kbs"
	
    Scenario: Questionário Vazio
       
        Given que eu estou na tela de criação de provas
        When eu deixar o questionário da prova vazio
        And eu clico em "Salvar"
        Then o sistema exibe uma mensagem de erro "digite alguma questão/conteúdo para sua prova"
